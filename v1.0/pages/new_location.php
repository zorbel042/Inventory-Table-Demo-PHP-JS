...
if (isset($_POST['name'])) {
  ...
  $query = "INSERT INTO stores (name, city, state) VALUES ('$name', '$city', '$state')";
...
<div class="container">
  <form method="POST" action="pages/new_location.php" id="new_location">
    <section class="content">
      <div class="card">
        <div class="card-body">
          <div class="row bottom-padding">
            <div class="col">
              <div class="form-group">
                <label>Name</label>
                <input type="text" id="storeName" name="name" class="form-control">
          ...
          <div class="row">
            <div class="col-12">
              <button type="button" class="btn btn-success float-right" onclick="validateLocation('new');">Submit New Location</button>
            </div>
          </div>
